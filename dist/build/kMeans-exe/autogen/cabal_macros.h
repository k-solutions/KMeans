...
#ifndef VERSION_container
#define VERSION_container "1.1.6"
#endif /* VERSION_container */
#ifndef MIN_VERSION_container
#define MIN_VERSION_container(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 6)
#endif /* MIN_VERSION_container */
...
#define CURRENT_COMPONENT_ID "kMeans-0.1.0.0-DkH8aQg9wmZDpiKp6SjeBc-kMeans-exe"
